...
public enum Error {
    ...
    FRIEND_REQUEST_ALREADY_SENT(400, "400_006", "이미 해당 유저에게 친구요청을 보냈습니다."),
    INVALID_FRIEND_REQUEST(400,"400_007","잘못된 친구요청 입니다"),
    //401,
    ...
    FRIEND_REQUEST_NOT_FOUND(401, "404_004", "해당 친구요청을 찾을 수 없습니다.");
